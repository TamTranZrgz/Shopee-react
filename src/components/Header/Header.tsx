      ...
      <div className='container'>
          ...
          {isAuthenticated && (
            ...
            >
              <div className='w-5 h-5 mr-2 flex-shrink-0'>
                <img
                  src='https://images.pexels.com/photos/850359/pexels-photo-850359.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'
                  alt='avatar'
        ...
        <div className='grid grid-cols-12 gap-4 mt-4 items-end'>
          ...
          <Popover
            ...
            renderPopover={
              <div className='max-w-[400px] text-sm bg-white relative shadow-md rounded-sm border border-gray-200'>
                <div className='p-2'>
                  <div className='text-gray-400 capitalize'>San Pham Moi Them</div>
                  <div className='mt-5'>
